LOG_FILE="/home/hello/project/stream_camera/restart_cam_truoc.log"
...
restart_be() {
    log_with_timestamp "Restarting the 'camera_ai_truoc' application using pm2."

    source /home/hello/.nvm/nvm.sh || exit 1  # Load nvm
    
    # Restart the 'be' application (it assumes 'be' is the name or id of your pm2 app)
    /home/hello/.nvm/versions/node/v18.18.2/bin/pm2 restart camera_ai_truoc || exit 1

    sleep 15
    curl -s -X 'GET' 'http://192.168.1.112:8010/camera_ai' -H 'accept: application/json'
